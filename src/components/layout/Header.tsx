      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex items-center gap-5 text-gray-600">
            <Link to="/" className={`hover:text-primary-700 transition-colors ${location.pathname === '/' ? 'font-semibold text-primary-700' : ''}`}>
              Home
            </Link>
            <Link to="/categories" className={`hover:text-primary-700 transition-colors ${location.pathname.includes('/categories') ? 'font-semibold text-primary-700' : ''}`}>
              Categories
            </Link>
          </div>
